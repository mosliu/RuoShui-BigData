...
public class ReadYmlUtil {
    ...
    public static void main(String[] args) {
      //  System.out.println(getProfiles());
        String dataXHome = ReadYmlUtil.getValueToString("datax.pypath");
        System.out.println(ReadYmlUtil.getValueToString("datax.pypath"));//get application.yml
        DATAX_HOME = dataXHome.endsWith(File.separator) ? dataXHome : dataXHome.concat(File.separator);
        System.out.println(DATAX_HOME);
