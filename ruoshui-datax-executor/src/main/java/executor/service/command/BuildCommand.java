package executor.service.command;
...
import executor.service.jobhandler.DataXConstant;
...
import static com.ruoshui.core.util.Constants.SPLIT_COMMA;


/**
 * DataX command build
 *
 * @author jingwk 2022-06-07
 */
public class BuildCommand {
    ...
    private static String buildDataXParam(TriggerParam tgParam) {
        ...
        if (StringUtils.isNotBlank(jvmParam)) {
            doc.append(DataXConstant.JVM_CM).append(DataXConstant.TRANSFORM_QUOTES).append(jvmParam).append(DataXConstant.TRANSFORM_QUOTES);
        }
