package com.ruoshui.common.utils.file;
...
import com.ruoshui.common.exception.file.FileNameLengthLimitExceededException;
import com.ruoshui.common.exception.file.FileSizeLimitExceededException;
import com.ruoshui.common.exception.file.InvalidExtensionException;
import com.ruoshui.common.utils.DateUtils;
import com.ruoshui.common.utils.StringUtils;
import com.ruoshui.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = RuoShuiConfig.getProfile();
    ...
    {
        int dirLastIndex = RuoShuiConfig.getProfile().length() + 1;
