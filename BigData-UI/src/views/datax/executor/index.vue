<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button  v-hasPermi="['datax:executor:add']" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate">
        添加
      </el-button>
    </div>
    <el-table
      ...
      <el-table-column
          ...
          <template slot-scope="scope">
              <el-button
                ...
                v-hasPermi="['datax:executor:edit']"
              >编辑</el-button>
              ...
              <el-button
                ...
                @click="handleDelete(scope.row)"
                 v-hasPermi="['datax:executor:remove']"
              >删除</el-button>
            </template>
      </el-table-column>
    </el-table>
