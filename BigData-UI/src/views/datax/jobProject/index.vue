<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate" v-hasPermi="['datax:jobProject:add']">
        添加
      </el-button>
    </div>
    <el-table
      ...
      <el-table-column
          ...
          <template slot-scope="scope">
              <el-button
                ...
                v-hasPermi="['datax:jobProject:edit']"
              >编辑</el-button>
              ...
              <el-button
                ...
                v-hasPermi="['datax:jobProject:remove']"
              >删除</el-button>
            </template>
      </el-table-column>
    </el-table>
