<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate" v-hasPermi="['datax:jobTemplate:add']">
        添加
      </el-button>
    </div>
    <el-table
      ...
      <el-table-column label="注册节点" align="center">
        <template slot-scope="scope">
          ...
          >
            ...
            <el-button slot="reference" size="medium">查看</el-button>
          </el-popover>
        </template>
      </el-table-column>
      ...
      <el-table-column
          ...
          <template slot-scope="scope">
              <el-button
                ...
                v-hasPermi="['datax:jobTemplate:edit']"
              >编辑</el-button>
              <el-button
                size="mini"
                type="text"
                ...
                v-hasPermi="['datax:jobTemplate:remove']"
              >删除</el-button>
            </template>
      </el-table-column>
    </el-table>
...
import * as jobTemp from '@/api/datax/datax-job-template'
