  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button
        ...
        icon="el-icon-edit"
        @click="handlerDelete"
        v-hasPermi="['datax:joblog:clearLog']"
      >
        清除
      </el-button>
    </div>
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="300">
        <template slot-scope="{row}">
          <el-button v-show="row.executorAddress" type="primary" @click="handleViewJobLog(row)"  v-hasPermi="['datax:joblog:logDetailCat']">日志查看</el-button>
          <el-button v-show="row.handleCode===0 && row.triggerCode===200" type="primary" @click="killRunningJob(row)" v-hasPermi="['datax:joblog:killJob']">
            终止任务
          </el-button>
        </template>
      </el-table-column>
