    ...
    <div class="body-wrapper">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="数据源" prop="ruleSourceId">
          <el-select v-model="form.ruleSource" placeholder="请选择数据源" @change="sourceSelectChanged">
            <el-option
        ...
        <el-form-item label="数据表" prop="ruleTableId">
          <el-select v-model="form.ruleTable" placeholder="请选择数据表" @change="tableSelectChanged">
            <el-option
        ...
        <el-form-item label="核查字段" prop="ruleColumnId">
          <el-select v-model="form.ruleColumn" placeholder="请选择核查字段" @change="columnSelectChanged">
            <el-option
       ...
       <el-form-item label="状态">
         <el-select v-model="form.status" placeholder="状态" style="width: 40%" >
             <el-option
               v-for="dict in dict.type.data_rule_statu"
               :key="dict.value"
               :label="dict.label"
               :value="dict.value"
             ></el-option>
