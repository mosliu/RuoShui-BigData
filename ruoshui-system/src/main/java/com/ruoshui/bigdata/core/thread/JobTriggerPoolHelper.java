...
public class JobTriggerPoolHelper {
    ...
    public void start() {
        fastTriggerPool = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    ...
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "ruoshui-ground, admin JobTriggerPoolHelper-fastTriggerPool-" + r.hashCode());
                    }
                });
        ...
        slowTriggerPool = new ThreadPoolExecutor(
                ...
                new ThreadFactory() {
                    @Override
                    public Thread newThread(Runnable r) {
                        return new Thread(r, "ruoshui-ground, admin JobTriggerPoolHelper-slowTriggerPool-" + r.hashCode());
                    }
                });
    }
    ...
    public void stop() {
        ...
        logger.info(">>>>>>>>> ruoshui-ground trigger thread pool shutdown success.");
    }
