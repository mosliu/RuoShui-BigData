            ...
            public void run() {
                ...
                while (!toStop) {
                    ...
                    try {
                        ...
                        if (!toStop) {
                            logger.error(">>>>>>>>>>> ruoshui-ground, job log report thread error:{}", e);
                        }
                    }
                ...
                logger.info(">>>>>>>>>>> ruoshui-ground, job log report thread stop");

            }
        });
        logrThread.setDaemon(true);
        logrThread.setName("ruoshui-ground, admin JobLogReportHelper");
        logrThread.start();
    }
