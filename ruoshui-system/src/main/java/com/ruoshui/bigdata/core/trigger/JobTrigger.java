package com.ruoshui.bigdata.core.trigger;


import com.ruoshui.bigdata.core.conf.JobAdminConfig;
import com.ruoshui.bigdata.core.route.ExecutorRouteStrategyEnum;
...
import com.ruoshui.bigdata.util.JSONUtils;
...
import com.ruoshui.core.enums.IncrementTypeEnum;
import com.ruoshui.core.glue.GlueTypeEnum;
import com.ruoshui.rpc.util.IpUtil;
import com.ruoshui.rpc.util.ThrowableUtil;
...
public class JobTrigger {
    ...
    private static void processTrigger(JobGroup group, JobInfo jobInfo, int finalFailRetryCount, TriggerTypeEnum triggerType, int index, int total) {
        ...
        logger.debug(">>>>>>>>>>> ruoshui-ground trigger start, jobId:{}", jobLog.getId());
        ...
        logger.debug(">>>>>>>>>>> ruoshui-ground trigger end, jobId:{}", jobLog.getId());
    }
    ...
    public static ReturnT<String> runExecutor(TriggerParam triggerParam, String address) {
        ...
        try {
            ...
            logger.error(">>>>>>>>>>> ruoshui-ground trigger error, please check if the executor[{}] is running.", address, e);
