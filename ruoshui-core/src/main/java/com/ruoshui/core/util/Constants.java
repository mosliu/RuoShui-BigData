...
public final class Constants {
    ...
    public static final String FLINKX_LOCAL_CMDWINDOW = "-mode local -jobType sync ";
    public static final String FLINKX_LOCAL_CMDWINDOW_JOB = "-job ";
    public static final String FLINKX_LOCAL_CMDWINDOW_END = " -flinkxDistDir flinkx-dist ";
